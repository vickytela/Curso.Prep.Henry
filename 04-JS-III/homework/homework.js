...
function agregarItemAlFinalDelArray(array, elemento) {
  ...
  // y devuelve el array
  // Tu código: o "array [array.length] = elemento;"
  array.push (elemento);
  return array;
}
...
function dePalabrasAFrase(palabras) {
  ...
  // Tu código: o " return palabras.join (" "); 
...
function arrayContiene(array, elemento) {
  ...
  // Tu código: o "return array.includes (elemento);"
for (var i= 0; i < array.length; i++) {
